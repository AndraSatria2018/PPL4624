                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?=base_url('admin/add_game')?>">Tambah Permainan</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="<?=base_url('admin/add_free_games')?>">Tambah Data Permainan Gratis</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?=base_url('gamedata/add_game')?>">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="inputEmail4">Nama Permainan/label>
    ...
    <footer class="main-footer">
        <div class="footer-left">
            Copyright &copy; 2021 <div class="bullet"></div> Program & Design by <a
                href="https://github.com/danuhartanto">danu</a> and Danu Hartanto - Team Developer
        </div>
