...
<head>
    ...
    <title>Admin Dashboard - Game-Indonesia</title>
...
?></div>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Admin - Game-Indonesia</div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown ">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-headset"></i>
                                <span>Store</span></a>
                            <ul class="dropdown-menu">
                                <li><a href="<?=base_url('admin/game_data')?>">Data Permainan</a></li>
                                <li><a href="<?=base_url('admin/Tambah_game')?>">Tambah Permainan</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?=base_url('admin/free_games')?>">Gratis Data Permainan</a>
                                </li>
                                <li><a class="nav-link" href="<?=base_url('admin/Tambah_free_games')?>">Tambah Free Games</a>
                                </li>
                            </ul>
                        </li>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Game-Indonesia - Tambah Free Game Data </h1>
                    </div>
                    <div class="col-md-12 bg-white p-4"
                        style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px">

                        <form method="post" enctype="multipart/form-data"
                            action="<?=base_url('gamedata/Tambah_free_games')?>">
                            ...
                            <div class="form-group">
                                <label for="inputTambahress">Deskripsi Game</label>
                                    ...
                                    <div class="input-group mt-4">
                                        <div class="custom-file">
                                            <input required type="file" name="image" class="custom-file-input"
                                                id="inputGroupFile01" aria-describedby="inputGroupFileTambahon01">
    ...
    <footer class="main-footer">
        <div class="footer-left">
            Copyright &copy; 2021 <div class="bullet"></div> Program & Design by <a
                href="https://github.com/danuhartanto">Danu Hartanto</a> and Team - Stisla Developer
        </div>
        <div class="footer-right">
            Made with <span class="text-danger"> &#10084;</span> by Danu
        </div>
    </footer>
    </div>
    </div>
    ...
    $('.custom-file-input').on('change', function() {
        ...
        $(this).next('.custom-file-label').TambahClass("selected").html(fileName);
    });
    </script>
