...
<head>
    <meta charset="utf-8" />
    <title>Game-Indonesia | Store</title>
                                                ...
                                                <div class="kt-widget19__wrapper">
                                                    <div class="kt-widget19__content">
                                                        <div class="kt-widget19__userpic">
                                                            <img src="<?=base_url('assets/')?>assets/media/users/Gambar1.png"
                                                                alt="">
                                                        </div>
                                                        <div class="kt-widget19__info">
                                                            ...
                                                            <span class="kt-widget19__time">
                                                                Admin , UX/UI Designer  @ Descienfy
                                                            </span>
                                                        </div>
                                ...
                                <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-widget19__wrapper">
                                            <div class="kt-widget19__content">
                                                <div class="kt-widget19__userpic">
                                                    <img src="<?=base_url('assets/')?>assets/media/users/Gambar4.jpeg"
                                                        alt="">
                                                </div>
                                                <div class="kt-widget19__info">
                                                    <a href="#" class="kt-widget19__username">
                                                        Andra Satria Hermawan
                                                    </a>
                                                    <span class="kt-widget19__time">
                                                        UX Designer | Leader @ Descienfy
                                                    </span>
                                                </div>
                                                <div class="kt-widget19__stats">
                                                    <span class="kt-widget19__number kt-font-brand">
                                ...
                                <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-widget19__wrapper">
                                            <div class="kt-widget19__content">
                                                <div class="kt-widget19__userpic">
                                                    <img src="<?=base_url('assets/')?>assets/media/users/Gambar3.jpeg"
                                                        alt="">
                                                </div>
                                                <div class="kt-widget19__info">
                                                    <a href="#" class="kt-widget19__username">
                            ...
                            <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                                ...
                                <div class="kt-portlet__body">
                                    <div class="kt-widget19__wrapper">
                                        <div class="kt-widget19__content">
                                            <div class="kt-widget19__userpic">
                                                <img src="<?=base_url('assets/')?>assets/media/users/Gambar2.jpeg" alt="">
                                            </div>
                                            <div class="kt-widget19__info">
                                                <a href="#" class="kt-widget19__username">
                                              Tifan Dwi Afianto
                            ...
                            <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                                ...
                                <div class="kt-portlet__body">
                                    <div class="kt-widget19__wrapper">
                                        <div class="kt-widget19__content">
                                            <div class="kt-widget19__userpic">
                                                <img src="<?=base_url('assets/')?>assets/media/users/Gambar5.jpeg" alt="">
                                            </div>
                                            <div class="kt-widget19__info">
                                                <a href="#" class="kt-widget19__username">
                                                  Anton Saputro
        ...
        <div class="kt-container">
            <div class="kt-footer__bottom">
                <div class="kt-footer__copyright">
                    2021&nbsp;&copy;&nbsp;<a href="Danuhartanto target=" _blank" class="kt-link">Descienfy /
                        Team PPL KEL 1</a>
                </div>
