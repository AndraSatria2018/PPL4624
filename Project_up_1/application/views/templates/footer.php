...
<footer class="page-footer font-small pt-4 mt-5">
    <div class="container">
        ...
        <div class="container-fluid text-center text-md-left">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-md-0 mt-3">
                    ...
                    <!-- Content -->
                    <h3 class="text-uppercase footer-text">Tentang GameUdns.</h3>
                    <p>GameUdns merupakan salah satu portal game yang ada di indonesia, yang menyediakan fasilitas untuk para
                        developer
        ...
        <!-- Copyright -->
        <div class="footer-copyright text-center small py-3">© 2021 Copyright :
            <a href="Udinus.ac.id" class="text-white"> Descienfy / Team 1</a>
        </div>
    </div>
    <!-- Copyright -->
